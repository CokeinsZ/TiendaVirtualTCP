...
public class DeleteDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel2.setText(" product  id  to delete ");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(61, 61, 61)
                        .addComponent(lId, javax.swing.GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (lId.getText().isBlank()) {
            JOptionPane.showMessageDialog(this, "Por favor inserte el id del producto a eliminar", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        if(JOptionPane.showConfirmDialog(this, "Seguro desea eliminar el producto de id " + lId.getText() + "\n\t Esta acción no se puede reversar") 
